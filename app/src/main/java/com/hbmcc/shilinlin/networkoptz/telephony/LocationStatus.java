...
public class LocationStatus {
    ...
    public LocationStatus(BDLocation bdLocation) {
        ...
        //状态部分
        gpsAccuracyStatus = bdLocation.getGpsAccuracyStatus();//如果是GPS位置，获得当前由百度自有算法判断的GPS质量, #GPS_ACCURACY_GOOD , #GPS_ACCURACY_MID, #GPS_ACCURACY_UNKNOWN
        coorType = bdLocation.getCoorType();//获取所用坐标系，以locationClientOption里设定的坐标系为准(wgs84,gcj02,bd09,bd09ll)
